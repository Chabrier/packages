...
DecisionLeftWidget::DecisionLeftWidget(DecisionPanel* d):
    QWidget(), ui(new Ui::leftWidget),// mScene(new
                                      // ForresterScene(f)),
    decision(d)
{
    ui->setupUi(this);
...
void
DecisionLeftWidget::reloadGeneral()
{
...
// void
// DecisionLeftWidget::onNumMethodUpdate(int index)
// {
//     if (index == 0) {//Euler
...
// void
// DecisionLeftWidget::tsChanged(double v)
// {
//     forrester->cppMetadata->setNumericalTimeStep(v);
// }

// void
// DecisionLeftWidget::onCompUpdate(const QString& /*comp*/)
// {
...
// void
// DecisionLeftWidget::qtChanged(double v)
// {
